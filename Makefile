...
$(ELF): main_v137.c main_v136_embed.c remote_service.c remote_service.h remote_worker.c remote_worker.h remote_ps5_source.c remote_ps5_source.h main_v132_embed.c main_v13_embed.c main_v12_embed.c main_v03.c astro_process_name.c
	$(CC) $(CFLAGS) -o $@ main_v137.c remote_service.c remote_worker.c remote_ps5_source.c astro_process_name.c $(LDADD)

$(ASTROKILL): astrokill.c
	$(CC) $(CFLAGS) -o $@ astrokill.c

clean:
	rm -f $(ELF) $(ASTROKILL) main_v12_embed.c main_v13_embed.c main_v132_embed.c main_v136_embed.c
