...
remote_worker_safe.c: remote_worker.c scripts/build_safe_remote_worker.py
	python3 scripts/build_safe_remote_worker.py remote_worker.c $@

$(ELF): $(CHIAKI_RPCRYPT) main_v137_build.c remote_service_safe.c remote_service.h remote_worker_safe.c remote_worker.h remote_ps5_source.c remote_ps5_source.h remote_pairing.c remote_pairing.h remote_page_v137.h astro_pair_client.c astro_pair_client.h astro_pair_crypto.c astro_pair_crypto.h chiaki_mbedtls_compat.c main_v132_embed.c main_v13_embed.c main_v12_embed.c main_v03.c astro_process_name.c
	$(CC) $(CFLAGS) $(PAIR_CFLAGS) -o $@ main_v137_build.c remote_service_safe.c remote_worker_safe.c remote_ps5_source.c remote_pairing.c astro_pair_client.c astro_pair_crypto.c chiaki_mbedtls_compat.c $(CHIAKI_RPCRYPT) astro_process_name.c $(LDADD)
...
clean:
	rm -f $(ELF) $(ASTROKILL) $(ASTROLOCK) main_v12_embed.c main_v13_embed.c main_v132_embed.c main_v136_embed.c main_v137_build.c remote_service_safe.c remote_worker_safe.c
